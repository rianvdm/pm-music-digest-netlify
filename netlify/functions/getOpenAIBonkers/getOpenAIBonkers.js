    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          ...
          {role: "system", content: "Pretend you are a musical snob. Provide helpful information, but also do a bored, snarky roast of Rian's music taste. It's ok to be mean, he finds it comforting."}          
        ],
